...
Ported from claudechic's QuietCollapsible — adapted for amplifier-tui.
"""
...
class QuietCollapsible(Collapsible):
    ...
    def __init__(
        ...
        *children: Widget,
        ...
        # Store factory before super().__init__ so we can decide whether
        # to pass children to parent.
        self._content_factory = content_factory
        self._content_mounted = False
        self._initial_collapsed = collapsed

        # If we have a factory and start collapsed, don't pass children
        # to parent.  Content will be created lazily on first expand.
    ...
    def _watch_collapsed(self, collapsed: bool) -> None:
        ...
        # the parent class makes here.  Scrolling is handled by the
        # chat view container.
